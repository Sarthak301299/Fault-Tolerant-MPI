...
#define EMPI_COMPLEX ((EMPI_Datatype)EMPI_DATATYPE_NULL)
#define EMPI_DOUBLE_COMPLEX ((EMPI_Datatype)EMPI_DATATYPE_NULL)
#define EMPI_LOGICAL ((EMPI_Datatype)EMPI_DATATYPE_NULL)
#define EMPI_REAL ((EMPI_Datatype)EMPI_DATATYPE_NULL)
#define EMPI_DOUBLE_PRECISION ((EMPI_Datatype)EMPI_DATATYPE_NULL)
#define EMPI_INTEGER ((EMPI_Datatype)EMPI_DATATYPE_NULL)
#define EMPI_2INTEGER ((EMPI_Datatype)EMPI_DATATYPE_NULL)
#define EMPI_2REAL ((EMPI_Datatype)EMPI_DATATYPE_NULL)
#define EMPI_2DOUBLE_PRECISION ((EMPI_Datatype)EMPI_DATATYPE_NULL)
#define EMPI_CHARACTER ((EMPI_Datatype)EMPI_DATATYPE_NULL)
